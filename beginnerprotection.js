...
for (var i = 0; i < localVillages.length; i++) {
    if (localVillages[i].newbie.toString().indexOf("tomorrow") == 0) {
        localVillagesDateOut.push(new Date("2021", today.getUTCMonth(), today.getUTCDate() + 1, localVillages[i].newbie.match(/([0-9]{2}):([0-9]{2})/)[1], localVillages[i].newbie.match(/([0-9]{2}):([0-9]{2})/)[2], "00", "000"));
    }
    if (localVillages[i].newbie.toString().indexOf("today") == 0) {
        console.log("today");
        localVillagesDateOut.push(new Date("2021", today.getUTCMonth(), today.getUTCDate(), localVillages[i].newbie.match(/([0-9]{2}):([0-9]{2})/)[1], localVillages[i].newbie.match(/([0-9]{2}):([0-9]{2})/)[2], "00", "000"));
    }
    ...
    if (localVillages[i].newbie != 0 && localVillages[i].newbie.indexOf("tomorrow") < 0 && localVillages[i].newbie.indexOf("today") < 0) {
        ...
        localVillagesDateOut.push(new Date("2021", parseInt(localVillages[i].newbie.match(/([0-9]{2}).([0-9]{2})/)[2] - 1), localVillages[i].newbie.match(/([0-9]{2}).([0-9]{2})/)[1], localVillages[i].newbie.match(/([0-9]{2}):([0-9]{2})/)[1], localVillages[i].newbie.match(/([0-9]{2}):([0-9]{2})/)[2], "00", "000"));
    }
}
...
for (var i = 0; i < localVillages.length; i++) {
    ...
    if (ignore == true) {
        ...
        if (localVillagesDateOut[i] != "out of BP") {
            //create date
            tempDate = localVillagesDateOut[i].getUTCDate() + "/" + (localVillagesDateOut[i].getUTCMonth() + 1) + "/2021 "
